...
const bikes = [
  {
    ...
    emoji: "🚵",
    desc: "Perfekt for norske stier og skogsbaner. 29-tommers hjul og 120mm fjæring.",
  },
  {
    name: "Fjord City 7",
    category: "Bysykkel",
    ...
    emoji: "🚲",
    desc: "Lett og elegant bysykkel med 7-trinns gir og integrert lås. Perfekt for pendlere.",
  },
  {
    name: "Fjord Gravel X",
    category: "Grusykkel",
    ...
    tagColor: "",
    emoji: "🚴",
    desc: "Takle asfalt, grus og alt imellom. Karbon-ramme og hydrauliske bremser.",
  },
  {
    name: "Fjord E-Sport",
    category: "El-sykkel",
    ...
    emoji: "⚡",
    desc: "Kraftig Bosch-motor med 80 km rekkevidde. Ta deg frem uten svette.",
  },
  {
    name: "Fjord Kids 20",
    ...
    tagColor: "",
    emoji: "🧒",
    desc: "Stødig og lett barnesykkel for 6–10 år. Inkluderer støttehjul og reflekser.",
  },
  {
    name: "Fjord Road Pro",
    ...
    tagColor: "",
    emoji: "🏆",
    desc: "Race-geometri og 22-trinns Shimano 105-gir. For de seriøse.",
  },
];
